  ...
  return data ?  (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        <p className='text-[#5044E5] py-4 font-medium'>Published on {Moment(data.createdAt).format('MMM Do YYYY ')}</p>
        <h1 className='text-2xl sm:text-5xl font-semibold max-w-2xl mx-auto text-gray-800'>{data.title}</h1>
        <h2 className='my-5 max-w-lg truncate mx-auto'>{data.subTitle}</h2>
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-[#5044E5]/30 bg-[#5044E5]/5 font-medium text-[#5044E5]'>Sophia Collins</p>
      </div>

      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
          <img src={data.image} alt="" className='w-full max-w-5xl mx-auto h-[450px] object-cover rounded-3xl mb-5' />
          ...
          <div className='max-w-3xl mx-auto'>
            ...
            <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
              ...
              <textarea onChange={(e)=> setContents(e.target.value)} value = {content}
                        placeholder='Comment' 
